...
<div ng-controller="TableController as table">
  <iui-table 
    ...
    emptyRowDataMessage="There's no data to display in this table."></iui-table>
</div>
```
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('/$iui-table/templates/iui-table.html',
    ...
    '      </tr>\n' +
    '    </thead>\n' +
    '    <tbody ng-if="!iuiTable.serverSideSorting && iuiTable.rowData">\n' +
    '      <tr\n' +
    ...
    '      </tr>\n' +
    '    </tbody>\n' +
    '    <tbody ng-if="!iuiTable.rowData">\n' +
    '      <tr>\n' +
    '        <td colspan="iuiTable.displayColumns.length" ng-bind="iuiTable.emptyRowDataMessage">There\'s no data to display in this table.</td>\n' +
    '      </tr>\n' +
    '    </tbody>\n' +
    '  </table>\n' +
    '  <iui-pager\n' +
