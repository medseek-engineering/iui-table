  ...
  $templateCache.put("template/pagination/pagination.html",
    ...
    " <div class=\"iui-pagination clearfix\" > " +
     " <div class=\"pull-left\" >" +
      ...
      // "<span class=\"pull-left margin-left margin-top-5 \">Page Size:</span>" +
      //"<select class=\"form-control margin-left margin-right\" style=\"width:80px;\"  ng-model=\"setNumberOfPages\" ng-change=\"setNoOfPages(setNumberOfPages)\" ng-options=\"paging for paging in pageOption\" ng-init=\"setNumberOfPages = pageOption[0]\"></select>  " +
